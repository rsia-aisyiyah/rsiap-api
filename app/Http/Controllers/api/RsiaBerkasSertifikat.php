...
class RsiaBerkasSertifikat extends Controller
{
    public function index(Request $request)
    {
        $rsia_surat_ppi = \App\Models\RsiaBerkasSertifikat::with(['penanggungjawab' => function ($q) {
    ...
    public function show(Request $request)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaBerkasSertifikat::with('penanggungjawab')->where('nomor', $request->nomor)->where('tgl_terbit', $request->tgl_terbit)->first();
    ...
    public function store(Request $request)
    {
        ...
        $rsia_surat_ppi = new \App\Models\RsiaBerkasSertifikat();
    ...
    public function update(Request $request)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaBerkasSertifikat::where('nomor', $request->nomor)->where('tgl_terbit', $request->tgl_terbit)->first();
    ...
    protected function getLastNomor($tgl_terbit)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaBerkasSertifikat::whereYear('tgl_terbit', $year)->max('nomor');
        if (!$rsia_surat_ppi) {
            return 1;
        }
