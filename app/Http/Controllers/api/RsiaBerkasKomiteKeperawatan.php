...
class RsiaBerkasKomiteKeperawatan extends Controller
{
    public function index(Request $request)
    {
        $rsia_surat_ppi = \App\Models\RsiaSuratKomiteKeperawatan::with(['penanggungjawab' => function ($q) {
        ...
        if ($request->sort) {
            ...
            $rsia_surat_ppi->orderBy('created_at', 'desc')->orderBy('nomor', 'desc');
        }
    ...
    public function show(Request $request)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaSuratKomiteKeperawatan::with('penanggungjawab')->where('nomor', $request->nomor)->where('tgl_terbit', $request->tgl_terbit)->first();
    ...
    public function store(Request $request)
    {
        ...
        $rsia_surat_ppi = new \App\Models\RsiaSuratKomiteKeperawatan();
    ...
    public function update(Request $request)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaSuratKomiteKeperawatan::where('nomor', $request->nomor)->where('tgl_terbit', $request->tgl_terbit)->first();
    ...
    protected function getLastNomor($tgl_terbit)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaSuratKomiteKeperawatan::whereYear('tgl_terbit', $year)->max('nomor');
