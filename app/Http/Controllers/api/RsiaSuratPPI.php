...
class RsiaSuratPPI extends Controller
{
    public function index(Request $request)
    {
        $rsia_surat_ppi = \App\Models\RsiaSuratPPI::with(['penanggungjawab' => function ($q) {
    ...
    public function show(Request $request)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaSuratPPI::with('penanggungjawab')->where('nomor', $request->nomor)->where('tgl_terbit', $request->tgl_terbit)->first();
    ...
    public function store(Request $request)
    {
        ...
        $rsia_surat_ppi = new \App\Models\RsiaSuratPPI();
        $rsia_surat_ppi->nomor = $this->getLastNomor(date('Y'));
    ...
    public function update(Request $request)
    {
        ...
        $rsia_surat_ppi = \App\Models\RsiaSuratPPI::where('nomor', $request->nomor)->where('tgl_terbit', $request->tgl_terbit)->first();
    ...
    {
        $rsia_surat_ppi = \App\Models\RsiaSuratPPI::whereYear('tgl_terbit', $tgl_terbit)->max('nomor');
