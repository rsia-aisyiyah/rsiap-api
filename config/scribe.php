...
return [
     ...
     */
    'description' => 'RSIA Api adalah API yang digunakan untuk mengakses data dari RSIA, yang mencakup data pasien, dokter, dan pegawai (untuk saat ini).',
    ...
    'auth' => [
         ...
         */
        'extra_info' => `
            JWT Token bisa didapatkan saat anda login ke sistem. Login bisa dilakukan dengan mengakses endpoint <code>/api/auth/login</code> dengan method <code>POST</code> dan mengirimkan <code>username</code> dan <code>password</code> sebagai parameter.
        `,
    ],
     ...
     */
    'intro_text' => <<<INTRO
Dokumentasi ini bertujuan untuk memberikan semua informasi yang Anda perlukan untuk bekerja dengan API kami

<aside>
Semua endpoint yang terdapat pada dokumentasi ini hanya dapat diakses oleh user yang terdaftar dan memiliki akses ke endpoint tersebut. Namun pada dasarnya perbedaan role atau <b>jabatan</b> pada kasus nyata, mempengaruhi aksesibilitas endpoint yang dapat diakses oleh user tersebut.
</aside>
INTRO
    ,
